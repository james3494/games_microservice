...
const takeoutsDb = makeTakeoutsDb({
    makeDb, buildGeneralDb 
});
const gamesDb = makeGamesDb({
    makeDb, buildGeneralDb 
});
const takeoutMethodsDb = makeTakeoutMethodsDb({
    makeDb, buildGeneralDb 
});
const packsDb = makePacksDb({
    makeDb, buildGeneralDb 
});
const packPurchasesDb = makePackPurchasesDb({
    makeDb, buildGeneralDb 
});
const ratingsDb = makeRatingsDb({
    makeDb, buildGeneralDb 
});
